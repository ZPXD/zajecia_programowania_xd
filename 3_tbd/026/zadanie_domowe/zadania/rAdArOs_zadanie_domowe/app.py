...
def form_b():
    ...
    if form.validate_on_submit():
        ...
        youtube_music = form.youtube_music.data

        string = '{}\n{}\n\n'.format(your_name, youtube_music)
        save_data2(string)
...
class Y(FlaskForm):
    ...
    youtube_music = StringField('Dobra muza na YT:', validators=[DataRequired()])
